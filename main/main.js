  ...
  try {
      ...
      if (response.ok) {
          if (releaseData.assets && releaseData.assets.length > 0) {
              ...
              if (downloadAsset) {
                  const assetUrl = downloadAsset.browser_download_url;
                  ...
                  console.log(`Latest release ZIP of ${repo} downloaded: ${assetUrl}`);
              } else {
                  console.error(`No ZIP file found for the latest release of ${repo}.`);
              }
          } else {
